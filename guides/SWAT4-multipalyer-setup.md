...
2. Open `FRTE1.37P1_MODDB_Version.7z` using 7-Zip and extract the folder `SEF-FR Tactical Edition` to the `SWAT 4` installation directory.
   ...
   ![Installation Directory](https://wiki.poglet.net/uploads/images/gallery/2024-11/scaled-1680-/image.png)

3. To run the game, open the `SEF-FR Tactical Edition` folder and run `LaunchSEF.bat`.
   
   ![Launch Game](https://wiki.poglet.net/uploads/images/gallery/2024-11/scaled-1680-/dyNimage.png)
...
3. Enter the host's IP address and connect.
   ...
   ![Join Server](https://wiki.poglet.net/uploads/images/gallery/2024-11/scaled-1680-/pqSimage.png)
